...
const IMAGE_URL = "https://p-town.dmm.com/upload/machines/4778/bonus.jpg";
const OUT_DIR = path.resolve("scripts", ".tmp");
const OUT_IMAGE_PATH = path.join(OUT_DIR, "yoshimune_4778_bonus.jpg");
...
async function main() {
	...
	// Note: We only use "eng" here because this repo doesn't bundle tesseract.js
	// traineddata files for "jpn". The image is mostly numeric so "eng" is enough.
	const langsToTry = ["eng"];
