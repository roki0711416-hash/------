...
export const machines = [
  ...
  // --- コナミアミューズメント パチスロ 転生したら剣でした（スマスロ）（p-town 4843）追加 ---
  {
    id: "konami_tenseiken",
    name: "パチスロ 転生したら剣でした（スマスロ）",
    maker: "コナミアミューズメント",
    series: "転生したら剣でした",
    inHall: true,
    category: "SMART",
    description:
      "フランボーナス確率と各種当選率での簡易判別。弱チャンス目CZ当選率とフランおやすみ中開始時のAT当選率は二項（trials/hits）で反映。数値はp-town(4843)より。",
    metricsLabels: {
      bigLabel: "フランボーナス",
      regLabel: null,
      totalLabel: null,
      extraMetrics: [{ id: "demonBattle", label: "デーモンバトル" }],
      binomialMetrics: [
        {
          id: "weakChanceCz",
          trialsLabel: "通常時 弱チャンス目回数",
          hitsLabel: "CZ当選回数",
          rateLabel: "［弱チャンス目］CZ当選率（通常）",
        },
        {
          id: "franOyasumiAt",
      ...
      settings: [
        {
          ...
          total: 398.6,
          rate: 97.9,
          extras: { demonBattle: 215.8 },
          binomialRates: { weakChanceCz: 0.03, franOyasumiAt: 0.09 },
        },
        {
          s: 2,
          big: 388.7,
          ...
          total: 388.7,
          rate: 99.0,
          extras: { demonBattle: 214.2 },
          binomialRates: { weakChanceCz: 0.04, franOyasumiAt: 0.1 },
        },
        {
          s: 3,
          big: 380.8,
          ...
          total: 380.8,
          rate: 100.7,
          extras: { demonBattle: 211.0 },
          binomialRates: { weakChanceCz: 0.05, franOyasumiAt: 0.11 },
        },
        {
          s: 4,
          big: 352.0,
          ...
          total: 352.0,
          rate: 106.7,
          extras: { demonBattle: 204.8 },
          binomialRates: { weakChanceCz: 0.07, franOyasumiAt: 0.12 },
        },
        {
          s: 5,
          big: 335.0,
          ...
          total: 335.0,
          rate: 110.1,
          extras: { demonBattle: 201.2 },
          binomialRates: { weakChanceCz: 0.09, franOyasumiAt: 0.13 },
        },
        {
          s: 6,
          big: 316.8,
          ...
          total: 316.8,
          rate: 112.1,
          extras: { demonBattle: 197.8 },
          binomialRates: { weakChanceCz: 0.11, franOyasumiAt: 0.14 },
        },
      ],
    },
  },
