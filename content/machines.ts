...
export const machines = [
  ...
  // --- サミー A-SLOT+ ディスクアップ ULTRAREMIX（p-town 4702）追加 ---
  {
    ...
    category: "SMART",
    description:
      "ボーナス確率（設定1/2/5/6）＋機械割での簡易判別。追加で、確定チェリー確率・スイカ確率も反映。数値はp-town（4702）より。機械割は『完全攻略時』の列を採用。50枚あたり約32.2G（設定1、独自調査値）。",
    metricsLabels: {
      bigLabel: "BIG",
      regLabel: "REG",
      totalLabel: "ボーナス合算",
      ...
      settings: [
        {
          ...
          total: 181.8,
          rate: 103.0,
          extras: { kakuteiCherry: 3276.8, suikaA: 59.6, suikaSum: 49.3 },
        },
        {
          s: 2,
          big: 284.3,
          ...
          total: 178.2,
          rate: 103.8,
          extras: { kakuteiCherry: 2978.9, suikaA: 59.1, suikaSum: 49.0 },
        },
        {
          s: 5,
          big: 273.8,
          ...
          total: 162.3,
          rate: 107.2,
          extras: { kakuteiCherry: 2340.6, suikaA: 57.0, suikaSum: 47.5 },
        },
        {
          s: 6,
          big: 260.9,
          ...
          total: 146.5,
          rate: 111.5,
          extras: { kakuteiCherry: 1927.5, suikaA: 54.4, suikaSum: 45.7 },
        },
      ],
    },
  },
