    ...
    return (
      <main className="mx-auto w-full max-w-xl px-4 pb-10 pt-6">
        <section className="rounded-2xl border border-white/[0.08] bg-white/[0.04] p-5">
          ...
          <div className="mt-4 rounded-lg border border-white/[0.08] bg-white/[0.03] p-3">
            <p className="text-sm font-semibold text-white">条件を選んでください</p>
            <p className="mt-1 text-sm text-muted">選択後にスレ一覧が表示され、そこからスレを立てられます。</p>
          </div>
              ...
              {PREFECTURES.map((p) => (
                <li key={p}>
                  <Link
                    ...
                    className="block rounded-xl border border-white/[0.08] bg-white/[0.04] px-4 py-3 text-sm font-semibold text-white"
                  >
                    {p}
                  </Link>
                </li>
                ...
                return (
                  <li key={th.id}>
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs text-white/40">{th.username}{extra ? `・${extra}` : ""}</p>
                    </Link>
                  </li>
                );
              })}
